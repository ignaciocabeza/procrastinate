...
class ProcrastinateShell(cmd.Cmd):
    ...
    def __init__(self, manager: manager.JobManager):
        super().__init__()
    ...
    def do_list_jobs(self, arg: str) -> None:
        ...
        for job in self.manager.list_jobs(**kwargs):  # type: ignore
    ...
    def do_list_queues(self, arg: str) -> None:
        ...
        """
        kwargs = parse_argument(arg)
        for queue in self.manager.list_queues(**kwargs):  # type: ignore
            print(
    ...
    def do_list_tasks(self, arg: str) -> None:
        ...
        """
        kwargs = parse_argument(arg)
        for task in self.manager.list_tasks(**kwargs):  # type: ignore
            print(
    ...
    def do_retry(self, arg: str) -> None:
        ...
        Example: retry 2
        """
        print_job(self.manager.set_job_status(arg, status="todo"))  # type: ignore
    ...
    def do_cancel(self, arg: str) -> None:
        ...
        Example: cancel 3
        """
        print_job(self.manager.set_job_status(arg, status="failed"))  # type: ignore
